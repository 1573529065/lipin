    ...
    <form class="Huiform" id="loginform" action="" method="post">
        <table class="table table-border table-bordered table-bg">
            ...
            <tr>
                <th></th>
                <td>
                    <button type="submit" class="btn btn-success radius" id="admin-password-save"
...
<script type="text/javascript" src="{{asset('admin/js/Validform_v5.3.2_min.js')}}"></script>
<script type="text/javascript" src="{{asset('admin/layer/layer.min.js')}}"></script>
