...
<head>
    ...
    <meta name="keywords" content="小礼品销售">
    <meta name="description" content="小礼品销售">
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="{{url('admin/index')}}">小礼品销售后台管理</a>
            <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="{{url('admin/index')}}"></a>
