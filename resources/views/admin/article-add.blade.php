        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                = "row cl" >
                    < div
                class
                = "col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2" >
                    < button
                ...
                src = "{{asset('admin/lib/jquery/1.9.1/jquery.min.js')}}" ></script>
                ...
                <script type="text/javascript"
                        src="{{asset('admin/lib/jquery.validation/1.14.0/jquery.validate.js')}}"></script>
                <script type="text/javascript"
                        src="{{asset('admin/lib/jquery.validation/1.14.0/validate-methods.js')}}"></script>
                <script type="text/javascript"
                        src="{{asset('admin/lib/jquery.validation/1.14.0/messages_zh.js')}}"></script>
                <script type="text/javascript"
                        src="{{asset('admin/lib/webuploader/0.1.5/webuploader.min.js')}}"></script>
