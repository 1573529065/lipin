...
<body>
<nav class="Hui-breadcrumb"><i class="icon-home"></i> 首页 <span class="c-gray en">&gt;</span> 资讯管理 <span
            class="c-gray en">&gt;</span> 分类管理 <a class="btn btn-success radius r mr-20"
...
<div class="pd-20 text-c">
    <form class="Huiform" action="/" method="post">
        ...
        <button type="button" class="btn btn-success" id="" name="" onClick="article_class_add(this);"><i
        ...
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr class="text-c">
                ...
                <td class="f-14"><a title="编辑" href="javascript:;"
                                    ...
                                    style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除"
                                                                                                  href="javascript:;"
                                                                                                  onclick="article_class_del(this,'1')"
                                                                                                  class="ml-5"
            ...
            <tr class="text-c">
                ...
                <td class="f-14"><a title="编辑" href="javascript:;"
                                    onclick="article_class_edit('2','620','160','分类编辑','article-class-edit.html')"
                                    style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除"
                                                                                                  href="javascript:;"
                                                                                                  onclick="article_class_del(this,'2')"
                                                                                                  class="ml-5"
                                                                                                  style="text-decoration:none"><i
                                class="icon-trash"></i></a></td>
            </tr>
            <tr class="text-c">
                ...
                <td class="text-l">&nbsp;&nbsp;├&nbsp;二级分类</td>
                <td class="f-14"><a title="编辑" href="javascript:;"
                                    onclick="article_class_edit('3','620','160','分类编辑','article-class-edit.html')"
                                    style="text-decoration:none"><i class="icon-edit"></i></a> <a title="删除"
                                                                                                  href="javascript:;"
                                                                                                  onclick="article_class_del(this,'3')"
                                                                                                  class="ml-5"
                                                                                                  style="text-decoration:none"><i
                                class="icon-trash"></i></a></td>
            </tr>
