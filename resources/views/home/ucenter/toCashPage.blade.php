...
<div data-role="page" id="cashPage">
	...
	<div data-role="main" class="ui-content">
		<form id="cashForm">
			<div>
				<input type="number" required="true" data-role="none"  min="100" style="text-decoration: none;border-radius:5px;height:2em;" placeholder="提现金币至少100金币" id="cash_form_gold" name="gold"/><span style="margin-left:0.5em;font-weight:bold;font-size:0.75em;">你有[0]金币</span>	
			</div>
