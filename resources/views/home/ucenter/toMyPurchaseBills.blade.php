...
<div data-role="page" id="myPurchaseBillsPage">
	...
	<div role="main" class="ui-content" style="padding:0.2em;">
	   <div>
	   		<div style="margin-top:0.5em;text-align:center;"><span class="sbold">共计发布</span>:<font id="totalBillQty">10</font> 条, <span class="sbold">进行中</span>:<font id="goingQty">1</font> 条,<span class="sbold">已完成</span>: <font id="finishedQty">9</font>条</div>
	   		<div style="margin-top:0.5em;text-align:center;"><span class="sbold">评价数据</span> 好评: <span class="sbold"><font color="green" id="goodCommentQty"> 10 </font> 次, 差评: <font color="red" id="badCommentQty">3</font> 次</span></div>
