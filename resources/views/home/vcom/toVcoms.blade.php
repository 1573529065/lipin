	...
	<script>
    	...
    	<div role="main" class="ui-content" style="padding:0px;font-size:0.75em;margin:0.1em 0.5em 0.1em 0.5em;">
			<div style="height:3em;text-align:center;line-height:2em;">
				<span style="font-weight:bold;margint-right:1em;">累计成功拜访:</span>【<span id="visitQty" style="font-weight:bold;color:red;"></span>】人次,<span style="font-weight:bold;">共计:【<font id="purchaseQty" style="color:red;"></font>】位采购入驻！</span>
			</div>
			<div class="ui-grid-a">
    		<!-- 
		...
		<div data-role="footer" data-position="fixed"  data-tap-toggle="false"> 
		    <div data-role="navbar">
		       <ul>
			        ...
			        <li><a href="/vcom/toVcoms.php" data-ajax="false" data-rel="dialog"  class="ui-btn-active ui-state-persist"  data-transition="flip">拜访采购</a></li>
