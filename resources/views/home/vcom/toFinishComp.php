	...
	<script>
		...
		<form id="finishCompForm">
			<div data-role="fieldcontain">
				...
				<input type="text" name="contactorMobile" id="f_contactorMobile" value="15612341234"  placeholder="联系电话" />
				...
				<a href="#" data-role="button" id="finishCompBtn" style="margin-top:1em;margin-left:3em;" class="ui-btn ui-btn-inline">提交</a>
			</div>
		</form>
		</div>
