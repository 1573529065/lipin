...
<head>
	...
	<div data-role="page" id="suppliersPage">
		...
		<div data-role="main" class="ui-content">
            ...
            <!--   <a href="#" data-inline="true" id="searchBtn" class="ui-btn ui-icon-search ui-btn-icon-notext ui-corner" style="float: right;margin-top: -2.6em;margin-right: 1em;"></a> -->
              
             <a href="#" data-inline="true" id="searchBtn" class="ui-btn ui-icon-search ui-btn-icon-notext ui-corner" style="float: right;margin-top: -2.6em;margin-right: 0.5em;"></a>
      		</div>
	    ...
	    <div data-role="navbar">
	       ...
	       <li><a href="/bill/toMain.php" data-ajax="false" data-rel="dialog"   data-transition="flip">采购列表</a></li>
	        	<li><a href="/supplier/toSupplierMgr.php" data-ajax="false"  data-rel="dialog"  class="ui-btn-active ui-state-persist"  data-transition="flip">供应商库</a></li>
	        <li><a href="/vcom/toVcoms.php" data-ajax="false" data-rel="dialog" data-transition="flip">拜访采购</a></li>
 		  
 		  	<li><a href="/ucenter/toCenter.php" data-ajax="false" data-rel="dialog" data-transition="flip">个人中心</a></li>
		</ul>
	    </div>
