...
<div data-role="page" id="myKeyWordsPage">
    ...
    <div data-role="header">
        ...
        <a href="/ucenter/toCenter.php" data-ajax="false" class="ui-btn ui-icon-back ui-icon-left ui-btn-inline ui-mini"
           data-transition="flip">返回</a>
    </div>
    ...
    <div role="main" class="ui-content">
        ...
        <a href="javascript:;" onclick="toAddMyKeyWord();" data-rel="dialog" data-role="button"
           class="ui-btn ui-btn-inline" style="margin-left:6em;margin-top:2em;">增加关键词</a>
